<script lang="ts">
  ...
  export let toggleModels: () => void;
  export let modelToggle: boolean;
  export let models: Agent[];
  export let model: Agent= { type: "", message: "", title: "", img: "", intro: "" }
  ...
  >
    ...
    >
      ...
      <div
        ...
        class="transition-all duration-300 {modelToggle ? 'rotate' : ''}"
      >
        <svg
          class="w-3.5 h-3.5"
          width="16"
